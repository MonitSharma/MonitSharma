...
`position` &nbsp;Research Engineer, SMU-Quantum<br><br>
`degree` &nbsp;&nbsp;&nbsp;M.S. Physics &amp; Data Science,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;IISER Mohali<br><br>
...
<sub>`papers` `implementations`</sub>
